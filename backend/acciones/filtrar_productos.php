    ...
    foreach ($productos as $fila) {
        ...
        echo "<tr>
                ...
                <td>
                    ...
                    <a href='../../backend/acciones/eliminar_producto.php?id={$fila['id_producto']}' class='action-icon action-delete' title='Eliminar' onclick='return confirm(\"¿Seguro que deseas eliminar el producto {$fila['nombre']}?\")'><i class='fa-solid fa-trash-can'></i></a>
                </td>
              </tr>";
    }
} else {
